  ...
  return (
    <div className="flex flex-col gap-2.5 relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center justify-between px-4 h-12 border border-[#E0E0E0] rounded-lg bg-white cursor-pointer text-left"
      >
        <span
          className={`font-fustat text-base ${
            selectedValue === initialValue ? "text-[#6F6C6A]" : "text-[#272B35]"
          }`}
        >
          {selectedValue}
        </span>
